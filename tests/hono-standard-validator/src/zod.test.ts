...
const app = new Hono()
    .post("/header", sValidator("header", header), (c): Response => {
    ...
    .post("/param/:id", sValidator("param", param), (c): Response => {
        return createJsonResponse(c, {
            data: {
    ...
    .post("/query", sValidator("query", query), (c): Response => {
        return createJsonResponse(c, {
            data: {
    ...
    .post("/json", sValidator("json", json), (c): Response => {
        return createJsonResponse(c, {
            data: {
